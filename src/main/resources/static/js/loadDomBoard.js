...
// import {CONTEXT_NAME} from './Project-Context.js';
		...
		$.ajax({
			...
			success:function(json){
				...
				for(let i=0;i<replyList.length;i++){
					...
					replyInfo += "	<textarea style=\"margin-left: -3px;\" id=\"reviseReply\" data-replyid='"+reply.replyid+"' class=\"comment\" name=\"comment\" cols=\"60\" rows=\"5\" disabled>"+reply.comments+"</textarea>";
